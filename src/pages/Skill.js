...
function Skill() {
  ...
  const SkillNotFound = () => {
    return (
      <ListItem key={0}>
        ...
        <ListItemText>No Skill Found</ListItemText>
      </ListItem>
    );
  };
  ...
  const currentItems = skill
    ...
    .filter((skill) =>
      skill.skillName.toLowerCase().includes(searchValue.toLowerCase())
    );
      ...
      <Paper sx={{ padding: "30px" }}>
        ...
        >
          ...
          >
            ...
            <Button
              onClick={() => setCreateSkillTrigger(true)}
              variant="contained"
              startIcon={<AddIcon />}
            >
              Add skill
          ...
          {!loading && (
            ...
            >
              <Box>
                ...
                <TextField
                  sx={{ mb: 2, mt: 2, ml: 2, width: 200, height: 50}}
                  size="small"
            ...
            >
              {displayedItems.map((skill, i, array) => {
                return (
                  ...
                  >
                    <ListItemAvatar>
                      <Avatar>{skillTypeIcon(skill)}</Avatar>
                    </ListItemAvatar>
                    <ListItemText
                      primary={skill.skillName}
                      secondary={skill.skillType}
                    />
                    <IconButton
                      edge="end"
                      aria-label="delete"
